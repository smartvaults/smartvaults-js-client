...
describe('SmartVaults', () => {
  ...
  describe('Key Agents', () => {
    ...
    it('saveSignerOffering works', async () => {
      const signerOffering: SignerOffering = { temperature: 'cold', device_type: 'coldcard', response_time: 5, cost_per_signature: { amount: 100, currency: 'USD' }, yearly_cost: { amount: 1000, currency: 'USD' }, network: Magic.Bitcoin }
    ...
    it('saveSignerOffering throws error if user is not a key agent', async () => {
      const signerOffering: SignerOffering = { temperature: 'cold', device_type: 'coldcard', response_time: 5, network: Magic.Bitcoin }
