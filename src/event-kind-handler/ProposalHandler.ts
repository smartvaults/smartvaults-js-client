  ...
  import { SpendingProposal, ProofOfReserveProposal, PublishedSpendingProposal, PublishedProofOfReserveProposal } from '../types'
  ...
  export class ProposalHandler extends EventKindHandler {
    ...
    protected async  _handle<K extends number>(proposalEvents: Event<K>[], getSharedKeysById: any): Promise<(PublishedSpendingProposal | PublishedProofOfReserveProposal)[]> {
